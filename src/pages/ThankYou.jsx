...
const ThankYou = () => {
    return (
        <section className="-mt-[4.6rem] rounded-lg py-5 px-6 md:p-0 md:h-full flex flex-col items-center justify-center max-w-xs md:max-w-md md:shadow-none mx-auto md:bg-none md:mt-0 my-auto font-medium text-marineBlue bg-white shadow-lg">
            ...
            <div className="mb-5 text-center md:mb-10">
                ...
                <p className="max-w-sm text-[14.5px] font-medium md:text-base text-coolGray md:max-w-full">
