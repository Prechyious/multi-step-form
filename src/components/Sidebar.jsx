const Sidebar = () => {
    return (
        <aside className="min-w-[375px] h-[172px] md:h-[568px] md:min-w-[264px] flex md:flex-col items-start gap-5 justify-center md:justify-start md:p-10 md:gap-10 p-5 bg-sideBarMobile md:bg-sideBar md:bg-no-repeat">
